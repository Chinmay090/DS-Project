...
void ParsedQuery::clear()
{
    ...
    this->groupAggFunction1 = "";
    this->groupAggColumn1 = "";
    this->groupBinaryOperator = "";
    this->groupCondValue = 0;
    this->groupAggFunction2 = "";
    this->groupAggColumn2 = "";
    this->groupResultColumn = "";
